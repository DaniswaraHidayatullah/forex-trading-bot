//+------------------------------------------------------------------+
//|                                           ScalperBoys_v4.mq5      |
//|   EA v4 STANDALONE (tanpa server). HYBRID regime-switch.          |
//|                                                                  |
//|   >>> VERSI 4.0 (config aktif) = HYBRID (InpEntryMode=2) <<<      |
...
//|                                                                  |
//|   Backtest 52hr: WR 47%, +$115/bln, DD ~$29 (28%!) - LEBIH agresif |
//|   & DD LEBIH GEDE dari mean-rev murni ($98/DD18). Pilihan sadar.   |
//|                                                                  |
//|   Changelog:                                                     |
//|     2.3 = mean-rev murni RSI35/65 (Prof/DD 5.6, paling efisien).   |
//|     4.0 = HYBRID: +leg trend-pullback pas tren kuat. +$17/bln tapi |
//|           DD +61% ($18->$29). Risk-adjusted lebih rendah (4.0).    |
//|           InpEntryMode=1 utk balik ke mean-rev murni (aman).       |
//|                                                                  |
